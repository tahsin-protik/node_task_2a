...
async function executeSeeds() {
  ...
  await db.setting.insert({ key: "site_logo", type: 0, value: "https://createdby.co/assets/img/logo.png" });
  await db.setting.insert({ key: "maintenance", type: 1, value: "0" });
  await db.setting.insert({ key: "version", type: 0, value: "1.0.0" });
  await db.setting.insert({ key: "copyright", type: 0, value: "Copyright © 2021 Createdby. All rights reserved." });
